...
stat_id = 'RL_DifOut_F0t1_WL01_WS25';
for s = 1:numel(SBJs)
...
stat_id    = 'RL_DifOut_F0t1_WL01_WS25';%'RL_DifOut_F01t06_WL005_WS005';
plt_id    = 'ts_F0to1_evnts_sigline';
for s = 1:numel(SBJs)
    SBJ08b_HFA_plot_crRT_mGLM(SBJs{s}, an_id, stat_id, plt_id, save_fig, fig_vis, fig_ftype);
end
%close all;

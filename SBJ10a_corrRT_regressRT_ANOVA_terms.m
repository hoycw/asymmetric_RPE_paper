...
%% Load Data
sbj_cmd = ['run /home/knight/hoycw/PRJ_Error/scripts/SBJ_vars/' SBJ '_vars.m'];
eval(sbj_cmd);
an_cmd = ['run /home/knight/hoycw/PRJ_Error/scripts/an_vars/' an_id '_vars.m'];
eval(an_cmd);
stat_cmd = ['run /home/knight/hoycw/PRJ_Error/scripts/stat_vars/' stat_id '_vars.m'];
eval(stat_cmd);

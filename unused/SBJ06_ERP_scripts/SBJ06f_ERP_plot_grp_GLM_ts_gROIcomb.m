function SBJ06f_ERP_plot_grp_GLM_ts_gROIcomb(SBJ_id,proc_id,an_id,model_id,stat_id,...
...
%% Plot Results
fig_dir = [root_dir 'PRJ_Error/results/ERP/GRP/GLM_ts/' model_id '/' stat_id '/' an_id '/gROIcomb/'];

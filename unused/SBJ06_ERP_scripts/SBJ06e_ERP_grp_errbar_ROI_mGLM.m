function SBJ06e_ERP_grp_errbar_ROI_mGLM(SBJ_id,proc_id,an_id,model_id,stat_id,roi_id,...
...
fig_name = [SBJ_id '_ERP_errbar_' model_id '_' stat_id '_' atlas_id '_' roi_id scat_suffix];
...
%% Save figure
if save_fig
    fig_dir = [root_dir 'PRJ_Error/results/ERP/GRP/errbar_ROI/'...

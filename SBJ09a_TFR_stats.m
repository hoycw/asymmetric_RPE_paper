...
% Calculates time frequency representation and saves the results
% INPUTS:
...
%       ft_freqanalysis: returns NaN for partially empty windows, e.g. an edge pre-trial,
%   	ft_preprocessing: returns filtered time series with an edge artifact.
...
error('stopped editing the stroop to update here');

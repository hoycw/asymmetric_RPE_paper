...
regressors  = {...
    ...
    'pRPE','nRPE',... % Valence split Reward Feedback
...
regressor_colors = {...
    ...
    [204 121 167]./255, [217,95,2]./255,... % CB reddish purple (like sRPE), dark orange

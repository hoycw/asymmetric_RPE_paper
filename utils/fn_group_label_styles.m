...
factors  = {'Dif','EV','Out','sRPE','Tim','Dif*Out','uRPE','RT'};
fact_colors = {[55 126 184]./256, [189 65 45]./256, ...
    [228 26 28]./256, [209 151 105]./256, ...
    [77 175 74]./256, ...
    [152 78  163]./256, [118 160 156]./256, ...
    [0.5 0.5 0.5]};
% Original before post-EEG restart:

...
error('This originally used importdata(), which started to leave off last 3 columns so this is part way to switch to textscan.');
...
fclose(csv_file);
% csv = importdata(csv_filename);
fields = csv.textdata(1,:);

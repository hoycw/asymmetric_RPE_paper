function [design,col_names,col_values] = fn_build_design_predictors_numeric(SBJ,stat_id)
...
for grp_ix = 1:numel(grp_lab)
    ...
    groups{grp_ix} = fn_condition_index(grp_lab{grp_ix}, trl_info);
end

%% Create matrix with trl_info fields
% add 'run',
col_names = {'trl_n','blk','rt','tol','hit'};

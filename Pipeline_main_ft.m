...
% SBJ = 'IR';
!!! add fn_compile_einfo(SBJ) after SBJ02_preproc
pipeline_id = 'main_ft';
...
if proc_vars.resample_freq~=1000
    error('ERROR!!! SBJ03_behav_parse assumes 1 kHz neural sampling rate!!!\n');
end
trl_info = SBJ03_behav_parse(SBJ,pipeline_id,1,1);
% Be sure to save the figures coming from this function!
%   i.e., SBJ_photodiode_segmentation.fig, etc.

%% ========================================================================
%   Step 6- Reject Bad Trials Based on Behavior and Bob
%  ========================================================================
trl_info_cln = SBJ04_reject_behavior(SBJ,trl_info,pipeline_id);
...
save(strcat(SBJ_vars.dirs.events,SBJ,'_trl_info_good.mat'),'trl_info');

function SBJ10c_grp_ANOVA_plot_ts_gROIcomb(SBJs,proc_id,stat_id,an_id,...
...
for s = 1:numel(SBJs)
    ...
    clear w2 elec SBJ SBJ_vars SBJ_vars_cmd
end
...
%% Plot Results
fig_dir = [root_dir 'PRJ_Error/results/HFA/GRP_ANOVA_ts/' stat_id '/' an_id '/gROIcomb/'];

...
data_dir = '/home/knight/hoycw/Data_Extraction/data/CP21/WM_Gating/Raw_EDF/'; %location where you want to save the experiment block
cd(data_dir);
path=strcat(data_dir,'EA024278_1-1+.edf'); %location of the edf file 
my_block_name = 'CP21_WM_gating.mat'; %task owner and task name
